...
@Configuration
@EnableJpaRepositories(basePackages = "com.eagleshing.ms.old.repository", entityManagerFactoryRef = "oldEntityManagerFactory", transactionManagerRef = "oldTransactionManager")
public class OldDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean oldEntityManagerFactory() {
		...
		factory.setPackagesToScan("com.eagleshing.ms.old.model");
