...
@Configuration
@EnableJpaRepositories(basePackages = "com.eagleshing.ms.scrapy.repository", entityManagerFactoryRef = "scrapyEntityManagerFactory", transactionManagerRef = "scrapyTransactionManager")
